...
<div class="container">
    <div class="row formulario">
        <div class="col-md-12">
            <?php
            if (isset($_POST['editaAviso'])) {
                echo '<div class = "display-4 text-center mb-3 mt-5 mb-2">Alterar Aviso</div>';
            } else {
                echo '<div class = "display-4 text-center mb-3 mt-5 mb-2">Inserir Aviso</div>';
            }
            ?>
        </div>
    </div>   
            ...
            <form class="form-group needs-validation justify-content-center" method="post" action="db/acoes.php" novalidate>
                ...
                <div class="botao text-center">
                    ...
                    if (isset($_POST['editaAviso'])) {
                        ...
                        echo '<button type="submit" class="btn btn-primary btn-block mb-2" id="botao" name="alteraAviso" class="btn">Atualizar</button>';
                    } else {
                        echo '<button type="submit" class="btn btn-primary btn-block mb-2" id="botao" name="salvaAviso" class="btn">Salvar</button>';
                    }
                    ?>                
                </div>   
            </form>
